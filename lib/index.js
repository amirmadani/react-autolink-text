  ...
  _createClass(AutoLinkText, [{
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        'span',
        null,
        (_context = (_context = (_context = (0, _match_parser2['default'])(text), prepareElements).call(_context, text, this.props), truncate).call(_context, this.props.maxLength), keyElements).call(_context)
      );
    }
  }]);
...
function prepareElements(text, props) {
  var elements = [];
  var lastIndex = 0;
  ...
  this.forEach(function (match) {
    ...
    elements.push(_react2['default'].createElement(
      'a',
      { href: match.getAnchorHref(), target: props.target ? props.target : '_blank' },
      props.linkLength && match.getAnchorText().length > props.linkLength ? match.getAnchorText().substring(0, props.linkLength) : match.getAnchorText()
    ));
